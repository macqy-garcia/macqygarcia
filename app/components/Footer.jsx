export const Footer = () => {
  return (
    <section className="fixed bottom-0 left-0 hidden lg:flex lg:w-full lg:justify-between lg:px-12">
      <div className="flex flex-col items-center gap-7">
        ...
        <div className="h-32 w-[1px] bg-[#CDD6F3]" />
      </div>
      <div className="flex translate-x-20 flex-col items-center justify-between">
        <p className="translate-y-32 rotate-90 font-mono text-xs text-[#CDD6F3]">
          garciamacqy@gmail.com
        </p>
        <div className="h-32 w-[1px] bg-[#CDD6F3]" />
      </div>
    </section>
