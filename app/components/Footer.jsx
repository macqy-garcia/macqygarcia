  ...
  return (
    <>
        ...
        >
          <g clipPath="url(#clip0_5_256)">
            <path
              ...
              className="stroke-[#a8b2d1] group-hover:stroke-[#64ffda]"
              strokeWidth="2"
              strokeLinecap="round"
      ...
      <div className="group hidden lg:block">
        ...
        >
          <a href="mailto:garciamacqy@gmail.com">garciamacqy@gmail.com</a>
        </p>
        <div className="fixed bottom-0 right-14 h-32 w-[1px] bg-[#a8b2d1]" />
      </div>
    </>
  );
};
